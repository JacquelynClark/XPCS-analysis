...
April 10th, 2026
 Jacquelyn Clark 
 Takes in files, bins the data in time into one second intervals, plots a 2D image, of x vs y 0 to 512 with a color bar legend.
"""
import os
import numpy as np
...
def create_time_bins(times_ns, bin_width_ns=1e9):
...
def report_bin_durations(times_ns, bins, max_print=5):
    ...
    """
    print("\nBin duration report (first few bins):")
...
def process_files(file_list, output_dir="binned_plots"):
    ...
    for file_path in file_list:
        ...
        for i, indices in enumerate(bins):
            ...
            # Output filename
            output_filename = f"{base_name}_bin_{i:04d}.png"
...
if __name__ == "__main__":
    ...
    """
    files = [
        r"C:\Users\roadr\LBNL Projects\data\FCGT_data_12-15-24\255K_1800s.t3pa",
        r"C:\Users\roadr\LBNL Projects\data\FCGT_data_12-15-24\360K_1800s.t3pa",
        # Add more files here
    ]
